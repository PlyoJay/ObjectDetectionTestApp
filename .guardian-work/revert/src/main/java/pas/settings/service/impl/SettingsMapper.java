...
public interface SettingsMapper {
	...
	String lockGuardianAccount(Map<String, Object> requestMap) throws SQLException, DataAccessException, Exception;

	int countGuardianNotification(Map<String, Object> requestMap) throws Exception;

	EgovMap selectGuardianNotification(Map<String, Object> requestMap) throws SQLException, DataAccessException, Exception;

	void insertGuardianNotification(Map<String, Object> requestMap) throws SQLException, DataAccessException, Exception;

	void updateGuardianNotification(Map<String, Object> requestMap) throws SQLException, DataAccessException, Exception;
