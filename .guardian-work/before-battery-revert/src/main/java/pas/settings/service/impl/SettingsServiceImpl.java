...
public class SettingsServiceImpl implements SettingsSerivce {
	...
	public EgovMap selectGuardianNotification() throws EgovBizException, SQLException, Exception {
		...
		if (setting == null) {
			...
			setting.put("battery50Enabled", 0);
			setting.put("battery25Enabled", 1);
			setting.put("battery10Enabled", 0);
	...
	public void saveGuardianNotification(HashMap<String, Object> requestMap) throws EgovBizException, SQLException, Exception {
		...
		params.put("battery50Enabled", enabledValue(requestMap.get("battery50Enabled")));
		params.put("battery25Enabled", enabledValue(requestMap.get("battery25Enabled")));
		params.put("battery10Enabled", enabledValue(requestMap.get("battery10Enabled")));
